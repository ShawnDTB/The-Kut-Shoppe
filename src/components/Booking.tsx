...
// Entry point for /book. Online edits to an existing appointment are
// currently paused (call the shop instead); everything else goes through
// the full multi-step BookingFlow.
export function Booking() {
  const editing = typeof window !== 'undefined' && new URLSearchParams(window.location.search).has('appointment');
  if (!editing) return <BookingFlow />;

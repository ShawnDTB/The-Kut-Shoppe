...
type View = 'counter' | 'receipts' | 'sales' | 'estimates' | 'front-desk' | 'overview' | 'booking' | 'appointments' | 'orders' | 'profile' | 'security' | 'professional' | 'professional-visits' | 'professional-setup' | 'professional-schedule' | 'setup-reviews';
const views: Array<[View, string]> = [['front-desk', 'Front desk'], ['sales', 'Sales preparation'], ['counter', 'Sales & cash'], ['receipts', 'Receipts'], ['estimates', 'Estimates'],['overview', 'Overview'], ['booking', 'Book a visit'], ['appointments', 'Appointments'], ['orders', 'Orders'], ['profile', 'Profile'], ['security', 'Security'], ['professional', 'Professional requests'], ['professional-visits', 'Your visits'], ['professional-schedule', 'Availability'], ['professional-setup', 'Professional setup'], ['setup-reviews', 'Setup reviews']];

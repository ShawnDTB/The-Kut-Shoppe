...
export function RoleDashboardV6() {
  ...
  const initialView: AccountView = typeof window !== 'undefined' && new URLSearchParams(window.location.search).has('order')
    ? 'orders'
    : 'appointments';
  ...
  return (
    <div className={`account-v6-shell account-v6-view-${view}`}>

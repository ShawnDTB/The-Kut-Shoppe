...
function PrivacyRoute() {
  return (
    <article className="legal-page route-content">
      ...
      <section><h2>Account information</h2><p>When account access is enabled, account details are stored on the server. Passwords are stored as one-way hashes. Email verification and password recovery use expiring codes. Optional phone numbers are contact details and are not used to verify account ownership.</p></section>
      ...
      <section><h2>Account service providers</h2><p>When accounts are enabled, Cloudflare hosts the account service and database and provides Turnstile abuse protection. Resend delivers verification and password recovery emails. Booking through Booksy or Crowned by Steph continues under the selected provider’s privacy notice; those appointments are not automatically imported into your account.</p></section>

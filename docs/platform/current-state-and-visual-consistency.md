...
Planning follow-up: [mobile, customer and in-person operations audit](launch-readiness-audit.md) includes competitor/API research, receipts, cash/card sales and a dependency-ordered [implementation backlog](launch-implementation-backlog.md). Use that backlog for upcoming work.
